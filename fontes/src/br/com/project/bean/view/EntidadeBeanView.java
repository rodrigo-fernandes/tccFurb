...
public class EntidadeBeanView extends BeanManagedViewAbstract {
	...
	private String url_fornecedor = "/cadastro/cad_crianca.jsf?faces-redirect=true";
	private String url_find_crianca = "/cadastro/find_crianca.jsf?faces-redirect=true";
